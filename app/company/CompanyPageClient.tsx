        ...
        <section className="mx-auto flex max-w-4xl flex-col gap-10 px-4 py-12">
          ...
          <section className="grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
              <h2 className="text-sm font-semibold text-slate-900">Sứ mệnh</h2>
            ...
            <div className="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-100">
              <h2 className="text-sm font-semibold text-slate-900">Tầm nhìn</h2>
              <p className="mt-2 text-sm leading-relaxed text-slate-600">
          ...
          {/* Liên hệ / Hợp tác */}
          <section className="rounded-2xl bg-sky-50/80 p-5 ring-1 ring-sky-100">
            <h2 className="text-sm font-semibold text-slate-900">
              Liên hệ &amp; Hợp tác
            </h2>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              ...
              <button
                ...
                className="inline-flex items-center rounded-md border border-sky-200 bg-white px-4 py-2 text-sm font-semibold text-sky-700 hover:bg-sky-50"
              >
